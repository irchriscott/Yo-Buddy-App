...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin{
    ...
    static const double _TriangleHeight = 28.0;

    // ignore: non_constant_identifier_names
    final Tween<BorderRadius> _BorderRadiusTriangle = new BorderRadiusTween(
        begin: const BorderRadius.only(
            topLeft: const Radius.circular(20.0),
            topRight: const Radius.circular(20.0),
        ),
        end: const BorderRadius.only(
            topLeft: const Radius.circular(_TriangleHeight),
            topRight: const Radius.circular(_TriangleHeight),
        ),
    );
                                    ...
                                    child: PhysicalShape(
                                        ...
                                        clipper: ShapeBorderClipper(
                                            shape: BeveledRectangleBorder(
                                                borderRadius: _BorderRadiusTriangle.lerp(1.0),
                                            )
                                        ),
                                        child: Container(
                                            decoration: BoxDecoration(
